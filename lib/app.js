...
var views = {
  ...
  displayShare: require('./views/displayShare'),
...
function App () {
  ...
  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/createShare', views.createShare)
  app.post('/user/:userId/:collectionId/:displayId/:version/:hash/share/createShare', views.createShare)

  app.get('/user/:userId/:collectionId/:displayId/:version/displayShare', requireUser, views.displayShare)
  app.post('/user/:userId/:collectionId/:displayId/:version/displayShare', requireUser, views.displayShare)

  app.get('/user/:userId/:collectionId/:displayId/:version/:hash/share/displayShare', views.displayShare)
  app.post('/user/:userId/:collectionId/:displayId/:version/:hash/share/displayShare', views.displayShare)
