...
var views = {
    ...
    editProfile: require('./views/editProfile'),
    ...
    userProfile: require('./views/userProfile'),
    org: require('./views/orgProfile'),
...
var actions = {
    ...
    createOrg: require('./actions/createOrg'),
    admin: {
...
function App() {
    ...
    app.all('/user/:userId/:collectionId/:displayId/:version/createTest', requireUser, actions.createTest);
