...
var views = {
    ...
    implementation: require('./views/implementation'),
    admin: {
...
var actions = {
    ...
    removeImplementation: require('./actions/removeImplementation'),
...
function App() {
    ...
    app.get('/user/:userId/:collectionId/:displayId/:version/implementation', requireUser, views.implementation);
    ...
    app.get('/user/:userId/:collectionId/:displayId/:version/implementation/remove', requireUser, actions.removeImplementation);
