...
module.exports = async function(req, res) {
    ...
    if (type == 'http://sbols.org/v2#Implementation'){
      ...
      var removeQuery = loadTemplate('sparql/removeImplementationOrTest.sparql', templateParams)
    }

    if (type == 'http://sbols.org/v2#Collection'){

      var test_query = "PREFIX sbh: <http://wiki.synbiohub.org/wiki/Terms/synbiohub#> SELECT ?o WHERE {<" + uri +  "> sbh:Test ?o}"
